...
router.route(`/auth/logout`).post(sellerAuthMiddleware, auth.logout);

router.route(`/profile/:seller_id`).get(sellerAuthMiddleware, profile.findOne);

router.route(`/profile`).get(sellerAuthMiddleware, profile.findSingle);

router.route(`/profile/`).patch(sellerAuthMiddleware, profile.update);
